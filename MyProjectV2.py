...
class DataF1Table(QWidget):
    ...
    def VisualTab(self):
        self.setWindowTitle("Formula1 Data V2")
    ...
    def sideWEBtab(self):
        ...
        # pix = QIcon("imgpics/f1-saves.jpg")
        # self.savedata.setIcon(pix)
        # self.savedata.setGeometry(QRect(0,0,260,110))
        # self.savedata.setIconSize(QSize(260, 110))
    ...
    def race_results(self):
        ...
        if self.data == "team ranks" and self.calender < 1958:
            ...
            if 'team' not in self.data:
                ...
                links, var, self.tabheader, dict = self.MultipleData()
            ...
            if self.tablemade != False:
                self.tablay.removeWidget(self.table)
            self.makeTable()
    ...
    def getList(self):
        ...
        # pix = QIcon("imgpics/f1-btn-del.jpg")
        # self.erase.setIcon(pix)
        # self.erase.setGeometry(QRect(0,0,260,110))
        # self.erase.setIconSize(QSize(260, 110))
    ...
    def fillTable(self, tabrow, tabcol, filler, myheader):
        ...
        self.setGeometry(100, 100, max + 350, 850)
    ...
    def MultipleData(self):
        ...
        if self.data == "race wins":
            return links, var, self.tabheader, dict
        else:
